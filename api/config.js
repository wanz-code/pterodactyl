...
// API Pterodactyl (MAT)
// ======================
export const BASE_URL_PTERODACTYL_API =
...
// ======================
export const config = {
  domain: process.env.DOMAIN || "https://wanzganteng.biz.id", // domain panel
  ptla: process.env.PTLA || "ptla_", // API key A
  ptlc: process.env.PTLC || "ptlc_", // API key C
  eggid: "15", // egg ID
  nestid: "5", // nest ID
  loc: "1", // lokasi node

  resellerGroupLink:
    "https://chat.whatsapp.com/CcHCBX5pNlWL1cKwagVkNV",

  // Cashify (Payment Gateway)
  lisencekey:
    process.env.LICENSE_KEY ||
    "cashify_dd4b6896be3aca9beca57c8faec3a756330498b189839d687f458aa022d9da61",
  webhooksecret:
    process.env.WEBHOOK_SECRET ||
    "cashify_0cd779dc56967b7c82c829cd6f27e5cd7a5ffb4b59c81e70150595bd16e65e60c57e9744b3e389f056e4e13871a503c0bb7966b18b0951e56569f1f60eee8281",

  // QRIS Config
  qrisstatis:
    process.env.QRIS_STATIC_ID ||
    "4bd17daa-8c09-422d-8c17-47eb684abaf5",
